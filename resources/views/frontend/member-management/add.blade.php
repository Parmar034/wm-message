                ...
                <div class="pcoded-inner-content">
                    <div class="main-body">
                        <div class="page-wrapper new-class">
                            ...
                            <div class="row">
                                <div class="card-body">
                                    <form id="updateUser" action="{{ route('member-management') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-xs-12 mb-5">
                                                ...
                                                <input class="form-control @error('member_code') is-invalid @enderror"
                                                    id="member_code" name="member_code" type="text"
                                                    placeholder="Please enter member code"
                                                    value="{{ $member->member_code ?? old('member_code') }}">
                                                @error('member_code')
                                                    <div class="alert text-danger ps-0">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-xs-12 mb-5">
                                                <label class="form-label" for="exampleFormControlInput1">Member
                                                    Name</label>
                                                <input class="form-control @error('member_name') is-invalid @enderror"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-xs-12 mb-5">
                                                ...
                                                <input class="form-control @error('location') is-invalid @enderror"
                                                    ...
                                                    value="{{ $member->location ?? old('location') }}">
                                                @error('location')
                                                    <div class="alert text-danger ps-0">{{ $message }}</div>
                                                @enderror
                                            </div>
